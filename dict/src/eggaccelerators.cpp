                              ...
                              EggVirtualModifierType accelerator_mods)
{
  ...
  accelerator_mods = (EggVirtualModifierType)((unsigned)accelerator_mods & EGG_VIRTUAL_MODIFIER_MASK);
                                 ...
                                 EggVirtualModifierType *virtual_mods)
{
      ...
      if ((1 << i) & concrete_mods)
        {
          ...
          cleaned = (EggVirtualModifierType)
                    (modmap->mapping[i] & ~(EGG_VIRTUAL_MOD2_MASK |
  ...
  *virtual_mods = (EggVirtualModifierType)virtyal;
}
...
egg_keymap_get_modmap (GdkKeymap *keymap)
{
  ...
  modmap = (EggModmap *)g_object_get_data (G_OBJECT (keymap),
                              "egg-modmap");
